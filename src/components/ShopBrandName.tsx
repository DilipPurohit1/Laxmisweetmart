...
export const ShopBrandName: React.FC<ShopBrandNameProps> = ({ size = 'md', className = '' }) => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center select-none ${className}`}>
      ...
      >
        {/* 7 Arched 5-Point Stars starting from 'X' of LAXMI to 'A' of MART in signature Maroon #6E1824 */}
        <g fill="#6E1824">
          {/* Star 1: Above 'X' of LAXMI (x ≈ 66.5) */}
          ...
          {/* Star 4: Top Center Crest above 'श्री' (x = 120.0) */}
          ...
          {/* Star 7: Above 'A' of MART (x ≈ 173.5) */}
        ...
        {/* Clean, Bold, High-Visibility Devanagari श्री in Royal Maroon #6E1824 */}
        <text
          x="120"
          y="48"
        ...
        {/* Bold Signature Maroon LAXMI SWEET MART */}
        <text
          x="120"
          y="71"
        ...
        {/* Prominent, Bold Subtitle: MAPUSA, GOA · ESTD. 1985 */}
        <text
          x="120"
          y="87"
